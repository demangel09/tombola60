...
var print = module.exports = function(content,callback){
	...
	doc.font('Cardo');
	doc.image('./routes/template_60_v5.png', 0, 0,{width: 612, height: 459});
	doc.fontSize(42);
...
//Box C ARRAY2 [0-12]
	...
	doc.text(content[2].box[3],539,41,{width:42,align:'center'});
	//2nd layer
	...
	doc.text(content[2].box[7],539,97,{width:42,align:'center'});
	//3rd layer
	...
	doc.text(content[2].box[11],539,154,{width:42,align:'center'});
	//game series
	doc.fontSize(13);
	doc.text("C3",468,213);
...
//Box E ARRAY4 [0-12]
	...
	doc.text(content[4].box[5],538,253,{width:42,align:'center'});
	...
	doc.text(content[4].box[11],540,312,{width:42,align:'center'});
	...
	doc.text(content[4].box[17],540,367,{width:42,align:'center'});
...
//Box F
	...
	doc.lineCap('butt')
		...
		.dash(5, {space: 10})
		.fillAndStroke("black");
	doc.image('./routes/template_60_v5.png', 0, 478,{width: 612, height: 459});
...
//Box C
	...
	doc.text(content[7].box[3],540,42+474,{width:42,align:'center'});
	...
	doc.text(content[7].box[7],540,100+474,{width:42,align:'center'});
	...
	doc.text(content[7].box[11],540,157+474,{width:42,align:'center'});
...
//Box E
	...
	doc.text(content[9].box[5],539,258+472,{width:42,align:'center'});
	...
	doc.text(content[9].box[11],539,317+472,{width:42,align:'center'});
	...
	doc.text(content[9].box[17],539,373+472,{width:42,align:'center'});
	doc.fontSize(12);
